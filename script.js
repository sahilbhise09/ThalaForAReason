function getValue() {
    ...
    if (ans.length == 7) {
        ...
        document.getElementById('dhoni').innerHTML = '<img src="./Assets/images/bolejokoyal.gif" alt="Thala Gif">'
        document.getElementById('audio').innerHTML = '<audio src="./Assets/music/Thala.mp3" autoplay loop></audio>';
    } else if (sums(ans) == 7) {
        ...
        document.getElementById('dhoni').innerHTML = '<img src="./Assets/images/moye.gif" alt="moye Gif" width="300px">'
        document.getElementById('output').innerHTML = `${ans} Not Thala for a reason`;
        document.getElementById('audio').innerHTML = '<audio src="./Assets/music/moye.mp3" autoplay loop></audio>';
    }
}
